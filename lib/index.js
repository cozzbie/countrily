...
var bulkdata = require("countrily-data"),
    _ = require("lodash");

var totalList = [];

_.each(bulkdata, function (data) {
...
var directory = _.transform(totalList, function(arr, country, key){
...
var Country = class {
    constructor(countryname, type) {
        ...
        else if (type == "ISO3") this.country = _.find(totalList, function (v, k) {  return v.ISO.alpha3 === countryname });
        else this.country = _.find(totalList, function (v, k) { return v.ISO.alpha2 === countryname });
    ...
    static shortnamesofall() {
        return _.map(totalList, function (v, k) { return v.ISO.alpha2 });
    }
}
